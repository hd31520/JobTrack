    ...
    return (
        ...
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-green-300 to-blue-400">
            <div className="w-full max-w-md p-8 rounded-2xl shadow-xl bg-white/10 backdrop-blur-sm">
                ...
                <div className='text-center text-white pt-3'>If You are no account here. please <Link className='text-blue-600 underline' to="/register">register</Link> </div>
                <div className='flex flex-col gap-4 py-8'>
                    <button onClick={githubLogin} className="btn bg-black text-white border-black">

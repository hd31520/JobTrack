...
const Register = () => {
    ...
    const handleRegister = async (e) => {
        e.preventDefault();
        const form = e.target;
        const file = form.photo.files[0];  // File input should have name="photo"
        ...
        // console.log(email, password,name,formData,name,apiKey)
        try {
            ...
            if (data.success) {
                ...
                CreateUser(email, password,name, data.data.url)
                    .then(result => {
                        console.log(result);
        ...
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-green-300 to-blue-400">
            <div className="w-full max-w-md p-8 rounded-2xl shadow-xl bg-white/10 backdrop-blur-sm">
                <div className="flex flex-col items-center mb-6">
                    ...
                    <h2 className="text-white text-xl tracking-widest"> REGISTER</h2>
                </div>
                ...
                <div className='text-center text-white pt-3'>Already have an account please <Link className='text-blue-600 underline' to="/login">login</Link> </div>
